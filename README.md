...
1. In order to create a Python package an ```__init__.py``` file is needed in the ```distributions```folder. In this example its content is:
  ```
...
6. To find the location of the package inbstallation try
  ```
